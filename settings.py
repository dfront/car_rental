...
SECRET_KEY = '1+5!m4*b)^ou+g7yh)(pf8j9)uz%p_!=g6#51t#tkcp$ak8scp'
...
MIDDLEWARE_CLASSES = (
    ...
    'account.middleware.HttpPostTunnelingMiddleware',
)
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_ROOT_PATH,'static/admin/templates/'),
)
